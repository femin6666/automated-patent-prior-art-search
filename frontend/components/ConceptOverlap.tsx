...
export default function ConceptOverlap({
  ...
  const totalCount = Math.max(matched.length + unmatched.length, matched.length ? matched.length + 1 : 0);
  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="px-2.5 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/25 text-[11px] font-mono font-bold text-indigo-300">
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        {matched.map((concept, i) => (
          <span
            ...
            title="Matched Technical Concept"
          >
        ...
        {unmatched.slice(0, 3).map((concept, i) => (
          <span
            key={`u-${i}`}
            ...
            title="Unmatched / Disclosed Elsewhere"
          >
