...
const Folder: React.FC<FolderProps> = ({
  ...
  const open = forceOpen || isOpenInternal;
  ...
  const scaleStyle: React.CSSProperties = { transform: `scale(${size})`, transformOrigin: "center" };

  return (
    <div style={scaleStyle} className={`folder-container ${className}`}>
      <div
        className={folderClassName}
        style={folderStyle}
        onClick={handleClick}
        onMouseEnter={() => setIsOpenInternal(true)}
        onMouseLeave={() => {
